(() => {
const IS_EDIT     = String('${JS_EDIT}').trim() === 'true';
const PREV_DATE   = '${fn:escapeXml(JS_PREV_DATE)}';
const PREV_AMOUNT = Number('${JS_PREV_AMT}') || 0;
...
document.getElementById('metaDate').textContent = todayStr();
